...
sourceId: "source:ck3-paradoxwikis-com:attributes"
...
- Source: `source:ck3-paradoxwikis-com:attributes`
- Revision: <https://ck3.paradoxwikis.com/Attributes?oldid=34884>
...
Use this page when a question needs CK3 mechanics context for Attributes. Combine these mechanics notes with current-save evidence paths and advisor models before giving player advice.
...
- Dread is a measure of how feared a ruler is by their vassals and courtiers. A character's dread can range from 0 to 100, with Nomadic and Meritocratic Khanate rulers having a higher cap of 150. Enough dread compared to another character's boldness can make characters either intimidated or terrified, allowing most diplomatic actions to succeed despite negative opinion.
...
- Mechanics content slug: `attributes`
- Source title: `Attributes`
- Source page length: `67168`
