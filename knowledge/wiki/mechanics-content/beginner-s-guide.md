...
sourceId: "source:ck3-paradoxwikis-com:beginner-s-guide"
sourceRevisionId: 34077
sourceOldidUrl: "https://ck3.paradoxwikis.com/Beginner%27s_guide?oldid=34077"
license: "CC BY-SA 3.0"
generatedAt: "2026-07-18T07:02:11.038Z"
contentHash: "2a8803ed83768363b7aac20b86a08b70a8a8971051ca7109529191d89b2ecca0"
---
...
- Source: `source:ck3-paradoxwikis-com:beginner-s-guide`
- Revision: <https://ck3.paradoxwikis.com/Beginner%27s_guide?oldid=34077>
...
Use this page when a question needs CK3 mechanics context for Beginner's guide. Combine these mechanics notes with current-save evidence paths and advisor models before giving player advice.
...
- Duke Robert of Apulia, a Norman conqueror who has established himself in southern Italy. As an independent ruler seeking to establish a kingdom, you have room to expand and grow with the chance to establish strong alliances with your neighbours. However, beware:
- Starting as the head of a large kingdom may be tempting, but often comes with the great responsibility of pleasing and managing dozens of potentially disloyal vassals. You will often find a strong vassal scheming against you early on, leaving you vulnerable to rebellion or attack if you cannot placate them.

### Before unpausing

- On loadup you will have automatically zoomed in to see your own realm. In the case of independent rulers you will see independent realms around you, whereas a vassal will see other vassals in their realm as well as their liege's direct holdings. Before you unpause the game, there are critical tasks that you should take care of.

### Choosing a lifestyle

- During the course of their lives, rulers will focus on many different aspects of governance and personal development that will determine how effective their rule is. In the choose a lifestyle menu, shown in a red diamond with three gold arrows pointing upwards, you will be prompted to choose from 5 different lifestyles, each with 3 different lifestyle focuses.
...
- In addition to foreign affairs, there are often many small domestic affairs that need handling in the first few days. It is important to ensure that your Realm Priest (if your Faith allows for the position) endorses you, which provides a boost to tax and levies. This can be as simple as appointing them to the position of court physician, or might require you to win their approval with gifts or a sway scheme.

### Feudal Contracts

- If playing as a feudal character, do check the obligations of your vassals (as a liege) and your own (as a vassal). As much as possible, try to increase tax contributions of your vassals without incurring tyranny; do this by reducing their levy contributions or by giving them a privilege.

### Becoming Rightful Liege

- Becoming your vassals' Rightful Liege is important to maximise your taxes and levies from them. The Rightful Liege mechanic makes it less economical to expand outside your de jure kingdom or empire as at its worst, you only get half of the taxes and levies. Create duchies which are de jure part of your kingdom or empire and grant them to counts (not dukes) which are not your de jure vassals.

### Deal with Factions as Liege

- Obtain strong hook Strong Hooks (Send Spymaster to Find Secrets (unreliable), fabricate strong hooks (requires intrigue Truth is Relative perk)).
...
### Use Factions as Vassal

- Faction members fight together against their liege.
- Join an already strong claimant Faction to get a weak hook Weak Hook on new liege (can be used to modify the vassal contract favorably, although fabricating a hook on liege might be safer and faster).
- Can usurp liege title as the claimant (can create claim with the stewardship Meritocracy perk).
...
- Note the quirks of your government type's succession laws:
- Feudal succession is dependent on availability of innovations and can be changed at the appropriate crown authority.
- Clan succession is usually some form of partition/ high partition, depending on House Unity. This means that Clan realms will most likely not split upon succession, with only one highest-tier title present. Clan governments must pay an additional 1500 Piety to change the realm succession to single heir.
- Tribal succession is locked to confederate partition.
...
- If you wish to increase your income, secure guaranteed Council Rights and force your liege to accept you as Steward; this gives you various monetary benefits.

### Succession

- Monitor which titles will be lost upon succession: Click the "Succession" tab under the "Realm" window.
- If maintaining realm integrity is desired, get out of Confederate Partition as soon as possible: It is the only succession law which creates new titles upon succession, thus almost guaranteeing a split in your realm unless you restrict the realm to the de jure counties of your primary duchy or kingdom.
...
- Feudal rulers can use title succession laws on their primary title to prevent realm fractures; the ruler must not have other titles of the same rank as their primary title.
...
- [[mechanics-content/laws|Laws]]
- [[mechanics-content/lifestyle|Lifestyle]]
- [[mechanics-content/resources|Resources]]
- [[mechanics-content/schemes|Schemes]]
- [[mechanics-content/titles|Titles]]
- [[mechanics-content/traits|Traits]]

## Machine Reference

- Mechanics content slug: `beginner-s-guide`
- Source title: `Beginner's guide`
- Source page length: `28203`
