...
title: "Innovation"
topicGroup: "cultureFaith"
sourceId: "source:ck3-paradoxwikis-com:innovation"
sourceRevisionId: 34955
sourceOldidUrl: "https://ck3.paradoxwikis.com/Innovation?oldid=34955"
license: "CC BY-SA 3.0"
generatedAt: "2026-07-18T07:02:11.038Z"
contentHash: "7948066ad2b63ac16572e697c93d3d6770ba953cd432904f7e1287b72966a495"
---
...
- Source: `source:ck3-paradoxwikis-com:innovation`
- Revision: <https://ck3.paradoxwikis.com/Innovation?oldid=34955>
...
Use this page when a question needs CK3 mechanics context for Innovation. Combine these mechanics notes with current-save evidence paths and advisor models before giving player advice.

## Mechanics Notes

### Overview

- Innovations represent technological, legal and ideological advances that a Culture can make. Once an innovation is unlocked, it can be used by any County and Character of the culture which unlocked it. Innovations are grouped into 4 categories: Military and Civic, Cultural, and Regional. The All Under Heaven DLC adds a fifth category - Silk Road.
...
- The Culture Head of each culture can choose one innovation at a time to be that culture's Fascination. The Fascination bonus is 20% as a base, plus 1% per the Culture Head's skill that matches the innovation's. With the Scientific perk, these numbers go up to 27% base and 1.35% per the Culture Head skill.
...
- Each Culture will be within one of 4 Eras which determine which innovations the Culture can unlock. Once at least 8 innovations from an Era are unlocked and the required minimum year is reached, the Culture will slowly progress to the next Era based on the average Development in the Culture's counties.

### Tribal innovations

- Unlocking 9 Civic or Military Tribal Innovations is required for the Adopt Feudal Ways and Adopt Clan Ways decisions.

### Civic innovations

- Civic innovations from the Tribal era have different effects depending on the character's government.

### Mural Sextant

- Mural Sextant is a special innovation that can only be obtained from a Court Scholar research project, with a 1% chance each time. It gives the following bonuses:
- development +0.2 Monthly Development Growth in Realm Capital
- learning lifestyle +5% Monthly Learning Lifestyle Experience

### Fritzware

- Fritzware is a special innovation that can only be obtained from a Court Scholar research project, with a 1% chance each time. It gives the following bonuses:

### Cultural innovations

- The Legionnaires innovation is also unlocked for all cultures whose culture head owns the Roman Empire title.
...
- Mechanics content slug: `innovation`
- Source title: `Innovation`
- Source page length: `61166`
