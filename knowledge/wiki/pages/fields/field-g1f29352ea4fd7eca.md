...
graphId: "field:g1f29352ea4fd7eca"
graphKind: "field"
status: "observed"
generatedFrom:
...
Graph ID: `field:g1f29352ea4fd7eca`

Kind: `field`

Pointer: `$.stories.active.<key>.variables.list[0].duration.undefined`

## Evidence

- Source: `source:rakaly-specimen-451e9bb9cff734cc`
- Observation: `field:$.stories.active.<key>.variables.list[0].duration.undefined` (schema_observation)

## Properties

- isRequired: `false`
- parentPointer: `$.stories.active.<key>.variables.list[0].duration`
- pointer: `$.stories.active.<key>.variables.list[0].duration.undefined`
