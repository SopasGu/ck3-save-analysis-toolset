...
graphId: "field:g5a8871f394bbea85"
graphKind: "field"
status: "observed"
generatedFrom:
...
Graph ID: `field:g5a8871f394bbea85`

Kind: `field`

Pointer: `$.dead_unprunable.<key>.dead_data.kills.undefined`

## Evidence

- Source: `source:rakaly-specimen-451e9bb9cff734cc`
- Observation: `field:$.dead_unprunable.<key>.dead_data.kills.undefined` (schema_observation)

## Properties

- isRequired: `false`
- parentPointer: `$.dead_unprunable.<key>.dead_data.kills`
- pointer: `$.dead_unprunable.<key>.dead_data.kills.undefined`
