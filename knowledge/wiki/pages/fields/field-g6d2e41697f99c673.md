...
graphId: "field:g6d2e41697f99c673"
graphKind: "field"
status: "observed"
generatedFrom:
...
Graph ID: `field:g6d2e41697f99c673`

Kind: `field`

Pointer: `$.provinces.<key>.variables.list[0].duration.undefined`

## Evidence

- Source: `source:rakaly-specimen-451e9bb9cff734cc`
- Observation: `field:$.provinces.<key>.variables.list[0].duration.undefined` (schema_observation)

## Properties

- isRequired: `false`
- parentPointer: `$.provinces.<key>.variables.list[0].duration`
- pointer: `$.provinces.<key>.variables.list[0].duration.undefined`
