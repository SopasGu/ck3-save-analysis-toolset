...
graphId: "field:g91348c8a88cbdf17"
graphKind: "field"
status: "observed"
generatedFrom:
...
Graph ID: `field:g91348c8a88cbdf17`

Kind: `field`

Pointer: `$.characters.dead_prunable.<key>.skill.undefined`

## Evidence

- Source: `source:rakaly-specimen-451e9bb9cff734cc`
- Observation: `field:$.characters.dead_prunable.<key>.skill.undefined` (schema_observation)

## Properties

- isRequired: `false`
- parentPointer: `$.characters.dead_prunable.<key>.skill`
- pointer: `$.characters.dead_prunable.<key>.skill.undefined`
